...
namespace AdSystem.Services
{
    public class FinanceService : IFinanceService
    {
        ...
        //        // ✅ NEW: Get final dynamic pricing (advertiser + country + city)
        ...
        //        if (publisher != null)
        //        {
        //            publisher.Balance += perImpressionAmount;
        //        }
        ...
        //            Description = $"Impression charged ({perImpressionAmount}) for Ad {ad.Id} on {website?.Domain}"
        //        });
        ...
        //        if (publisher != null)
        //            publisher.Balance += perClickAmount;
        ...
        //            Description = $"Click charged ({perClickAmount}) for Ad {ad.Id} on {website?.Domain}"
        //        });
