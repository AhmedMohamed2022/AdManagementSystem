...
{
    /// <inheritdoc />
    public partial class finalDelivery : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CPM = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
                    CPC = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: false),
                    UpdatedAt = table.Column<DateTime>(type: "datetime2", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_AdPricingRules", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ClickTokenUsages", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_WalletTransactions_AspNetUsers_FromUserId",
                        column: x => x.FromUserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_WalletTransactions_AspNetUsers_ToUserId",
                        column: x => x.ToUserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ScriptKey = table.Column<string>(type: "nvarchar(64)", maxLength: 64, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Category = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: true),
                    BannerSizeId = table.Column<int>(type: "int", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Ads_BannerSizes_BannerSizeId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    Name = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: false),
                    ZoneKey = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    BannerSizeId = table.Column<int>(type: "int", nullable: false),
                    WebsiteId = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_AdPlacements_BannerSizes_BannerSizeId",
                        column: x => x.BannerSizeId,
                        principalTable: "BannerSizes",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_AdPlacements_Websites_WebsiteId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Country = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: true),
                    City = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: true),
                    EarnedAmount = table.Column<decimal>(type: "decimal(18,6)", nullable: false),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AdPlacements_BannerSizeId",
                table: "AdPlacements",
                column: "BannerSizeId");

            migrationBuilder.CreateIndex(
                name: "IX_AdPlacements_WebsiteId",
                table: "AdPlacements",
                column: "WebsiteId");

            migrationBuilder.CreateIndex(
                name: "IX_AdPricingRules_RuleType_Country_City_AdvertiserId",
                table: "AdPricingRules",
                columns: new[] { "RuleType", "Country", "City", "AdvertiserId" });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ClickTokenUsages_Jti",
                table: "ClickTokenUsages",
                column: "Jti",
                unique: true);
